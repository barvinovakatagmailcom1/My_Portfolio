...
function getImagesForFolder(folder) {
    ...
    const folderImages = {
        '2024-03': generateImageList('images/2024-03/', 20, 'png'), // 20 зображень у форматі PNG
        '2024-04': generateImageList('images/2024-04/', 15, 'png'), // 15 зображень у форматі PNG
        ...
        '2024-07': generateImageList('images/2024-07/', 10, 'png'), // 10 зображень у форматі PNG
    };
