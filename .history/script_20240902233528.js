...
function getImagesForFolder(folder) {
    ...
    const folderImages = {
        '2024-03': generateImageList('images/2024-03/', 15, 'png'), // 20 зображень у форматі PNG
        '2024-04': generateImageList('images/2024-04/', 30, 'png'), // 15 зображень у форматі PNG
        '2024-05': generateImageList('images/2024-05/', 25, 'png'), // 25 зображень у форматі PNG
        '2024-06': generateImageList('images/2024-06/', 30, 'png'), // 30 зображень у форматі PNG
        '2024-07': generateImageList('images/2024-07/', 24, 'png'), // 10 зображень у форматі PNG
    };
