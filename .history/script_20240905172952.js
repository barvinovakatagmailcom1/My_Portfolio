...
function getImagesForFolder(folder) {
    ...
    const folderImages = {
        '2024-03': generateImageList('images/2024-03/', 1, 'jpg'),
        '2024-04': generateImageList('images/2024-04/', 1, 'jpg'), 
        '2024-05': generateImageList('images/2024-05/', 1, 'jpg'), 
        '2024-06': generateImageList('images/2024-06/', 1, 'jpg'), 
        '2024-07': generateImageList('images/2024-07/', 1, 'jpg'), 
    };
...
function showSlides(n) {
    ...
    console.log("Displaying image:", images[slide])
...
function plusSlides(n) {
    ...
    console.log("Aktueller Bildpfad:",
        images[slideIndex]);
}
